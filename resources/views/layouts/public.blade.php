...
<head>
    ...
    <title>@yield('title', 'The Grand Hotel & Spa')</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarPublic">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('rooms') ? 'active' : '' }}" href="{{ url('/rooms') }}">Rooms</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('dining') ? 'active' : '' }}" href="{{ url('/dining') }}">Dining</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('conference') ? 'active' : '' }}" href="{{ url('/conference') }}">Conference</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('events') ? 'active' : '' }}" href="{{ url('/events') }}">Events</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('gallery') ? 'active' : '' }}" href="{{ url('/gallery') }}">Gallery</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('contact') ? 'active' : '' }}" href="{{ url('/contact') }}">Contact</a>
                    </li>
                    <li class="nav-item ms-lg-2">
                        <a class="btn btn-gold btn-sm mt-lg-1" href="{{ url('/rooms') }}">Book Now</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="{{ url('/rooms') }}">Rooms & Suites</a></li>
                        <li class="mb-2"><a href="{{ url('/dining') }}">Dining</a></li>
                        <li class="mb-2"><a href="{{ url('/conference') }}">Conference</a></li>
            ...
            <div class="footer-bottom">
                <p>&copy; {{ date('Y') }} The Grand Hotel & Spa. All rights reserved.</p>
            </div>
        </div>
    </footer>
